...
- A Bastion is used to securely administer EC2 instances (Using SSH or RDP). Bastionsare called Jump Boxes in Australia
...
- Steps to creating a direct connect connection
    ...
    - You can control traffice using traffic dials. This is done within the endpoint group
...
- you can used route tables to limit how VPCs talk to one another
- works with direct connect as well as VPN connections
- support IP multicast (not supported by any other AWS service)

VPN Hub
- If you have multiple sites, each with its own VPN connection, you can useAWS VPN CloudHub to connect those sites together(Hub-and-spoke model)
